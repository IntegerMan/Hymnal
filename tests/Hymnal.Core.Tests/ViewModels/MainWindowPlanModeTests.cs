    ...
    private sealed class TestContext : IDisposable
    {
        ...
        public MainWindowViewModel CreateMainWindow()
        {
            ...
            return new MainWindowViewModel(
                ...
                new ChapterInfoViewModel(EditorViewModel, Workspace, PhaseDataService, TargetsService, SettingsStore, NotificationService, new WordCountHistoryService(MetadataStore)),
